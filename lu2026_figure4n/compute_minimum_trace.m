function [avgTrace, paramsUsed] = compute_minimum_trace (traces, varargin)
%% Computes the minimum of traces that are not necessarily the same length
% Usage: [avgTrace, paramsUsed] = compute_minimum_trace (traces, varargin)
% Explanation:
%       TODO
% Example(s):
%       TODO
% Outputs:
%       avgTrace    - the minimum trace
% Arguments:    
...
% File History:
% 2019-01-03 Adapted from compute_maximum_trace.m
% 
